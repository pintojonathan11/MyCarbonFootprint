...
import 'package:plastic_counter/MainPage/CustomizeUnits.dart';
...
class HomeTrackPage extends StatefulWidget {
  HomeTrackPage({Key key}) : super(key: key);

  @override
  HomeTrackPageState createState() => HomeTrackPageState();
}

class HomeTrackPageState extends State<HomeTrackPage> {
  Future data;
            ...
            return Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image:
                      AssetImage("assets/images/recycle_city_background.jpeg"),
